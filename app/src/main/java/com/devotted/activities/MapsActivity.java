...
public class MapsActivity extends AppCompatActivity implements GoogleMap.OnMarkerClickListener,
            ...
            public void onPageSelected(int position) {
                ...
                if (flag) {
                    ...
                    if (prevMarker != null) {
                        ...
                        View view = View.inflate(MapsActivity.this, R.layout.map_marker_text, null);
                    ...
                    if (!marker.equals(prevMarker)) {
                        ...
                        iconFactory.setRotation(0);
                        iconFactory.setBackground(null);
                        View view = View.inflate(MapsActivity.this, R.layout.map_marker_text_active, null);
                        TextView tvVendorTitle;

                        tvVendorTitle = view.findViewById(R.id.tv_vendor_title);
                        tvVendorTitle.setText(myDealsList.get(position).rating);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        for (int j = 0; j < myDealsList.size(); j++) {
            ...
            options.icon(BitmapDescriptorFactory.fromBitmap(iconFactory.makeIcon(myDealsList.get(j).rating)));
