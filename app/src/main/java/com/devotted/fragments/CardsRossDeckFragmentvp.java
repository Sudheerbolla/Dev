...
public class CardsRossDeckFragmentvp extends BaseFragment implements IClickListener, View.OnClickListener {
    ...
    public CardsRossDeckFragmentvp() {
    }

    public static CardsRossDeckFragmentvp newInstance(String text) {
        CardsRossDeckFragmentvp categoryDetailsFragment = new CardsRossDeckFragmentvp();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_cards_rossdeck_vp, container, false);
        initComponents();
        return rootView;
    }
