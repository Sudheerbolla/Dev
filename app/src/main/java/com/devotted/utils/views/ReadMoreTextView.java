package com.devotted.utils.views;
...
public class ReadMoreTextView extends CustomTextView {
    ...
    private boolean readMore = true, isReadAtleastOnce = false;
...
//        this.colorClickableText = typedArray.getColor(R.styleable.ReadMoreTextView_colorClickableText, ContextCompat.getColor(context, R.color.colorBlack));
    ...
    private CharSequence getTrimmedText(CharSequence text) {
        if (trimMode == TRIM_MODE_LENGTH) {
            if (text != null && text.length() > trimLength) {
                return readMore ? updateCollapsedText() : updateExpandedText();
            }
        }
    ...
    public boolean getIsExpandedOnce() {
